...
// MongoClientProvider is an autogenerated mock type for the MongoClientProvider type
type MongoClientProvider struct {
	mock.Mock
}

// Connect provides a mock function with given fields: ctx
func (_m *MongoClientProvider) Connect(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *MongoClientProvider) Database(name string, opts ...*options.DatabaseOptions) *mongo.Database {
...
func (_m *MongoClientProvider) Disconnect(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *MongoClientProvider) ListDatabaseNames(ctx context.Context, filter interface{}, opts ...*options.ListDatabasesOptions) ([]string, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MongoClientProvider) ListDatabases(ctx context.Context, filter interface{}, opts ...*options.ListDatabasesOptions) (mongo.ListDatabasesResult, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MongoClientProvider) NumberSessionsInProgress() int {
	ret := _m.Called()
...
func (_m *MongoClientProvider) Ping(ctx context.Context, rp *readpref.ReadPref) error {
...
func (_m *MongoClientProvider) StartSession(opts ...*options.SessionOptions) (mongo.Session, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MongoClientProvider) UseSession(ctx context.Context, fn func(mongo.SessionContext) error) error {
...
func (_m *MongoClientProvider) UseSessionWithOptions(ctx context.Context, opts *options.SessionOptions, fn func(mongo.SessionContext) error) error {
...
func (_m *MongoClientProvider) Watch(ctx context.Context, pipeline interface{}, opts ...*options.ChangeStreamOptions) (*mongo.ChangeStream, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
type mockConstructorTestingTNewMongoClientProvider interface {
	mock.TestingT
	Cleanup(func())
}

// NewMongoClientProvider creates a new instance of MongoClientProvider. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMongoClientProvider(t mockConstructorTestingTNewMongoClientProvider) *MongoClientProvider {
	mock := &MongoClientProvider{}
	mock.Mock.Test(t)
