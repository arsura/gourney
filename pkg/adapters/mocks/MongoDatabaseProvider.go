...
// MongoDatabaseProvider is an autogenerated mock type for the MongoDatabaseProvider type
type MongoDatabaseProvider struct {
	mock.Mock
}

// Aggregate provides a mock function with given fields: ctx, pipeline, opts
func (_m *MongoDatabaseProvider) Aggregate(ctx context.Context, pipeline interface{}, opts ...*options.AggregateOptions) (*mongo.Cursor, error) {
...
func (_m *MongoDatabaseProvider) Client() *mongo.Client {
	ret := _m.Called()
...
func (_m *MongoDatabaseProvider) Collection(name string, opts ...*options.CollectionOptions) *mongo.Collection {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MongoDatabaseProvider) CreateCollection(ctx context.Context, name string, opts ...*options.CreateCollectionOptions) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MongoDatabaseProvider) CreateView(ctx context.Context, viewName string, viewOn string, pipeline interface{}, opts ...*options.CreateViewOptions) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MongoDatabaseProvider) Drop(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *MongoDatabaseProvider) ListCollectionNames(ctx context.Context, filter interface{}, opts ...*options.ListCollectionsOptions) ([]string, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MongoDatabaseProvider) ListCollectionSpecifications(ctx context.Context, filter interface{}, opts ...*options.ListCollectionsOptions) ([]*mongo.CollectionSpecification, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MongoDatabaseProvider) ListCollections(ctx context.Context, filter interface{}, opts ...*options.ListCollectionsOptions) (*mongo.Cursor, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MongoDatabaseProvider) Name() string {
	ret := _m.Called()
...
func (_m *MongoDatabaseProvider) ReadConcern() *readconcern.ReadConcern {
	ret := _m.Called()
...
func (_m *MongoDatabaseProvider) ReadPreference() *readpref.ReadPref {
	ret := _m.Called()
...
func (_m *MongoDatabaseProvider) RunCommand(ctx context.Context, runCommand interface{}, opts ...*options.RunCmdOptions) *mongo.SingleResult {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MongoDatabaseProvider) RunCommandCursor(ctx context.Context, runCommand interface{}, opts ...*options.RunCmdOptions) (*mongo.Cursor, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MongoDatabaseProvider) Watch(ctx context.Context, pipeline interface{}, opts ...*options.ChangeStreamOptions) (*mongo.ChangeStream, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *MongoDatabaseProvider) WriteConcern() *writeconcern.WriteConcern {
	ret := _m.Called()
...
type mockConstructorTestingTNewMongoDatabaseProvider interface {
	mock.TestingT
	Cleanup(func())
}

// NewMongoDatabaseProvider creates a new instance of MongoDatabaseProvider. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMongoDatabaseProvider(t mockConstructorTestingTNewMongoDatabaseProvider) *MongoDatabaseProvider {
	mock := &MongoDatabaseProvider{}
	mock.Mock.Test(t)
